...
<div class="pageContent">
	<form method="post" action="management/ui/template/querytemplate/savecopy" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
