...
<div class="pageContent">
	<form method="post" action="management/ui/template/querytemplate/item_save" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label>参照类型：</label>
				<input type="text" value="${item.reftype }" name="reftype" size="30" value="SYSTEM"/>
			</p>
			<p>
				<label>是否编辑：</label>
			...
			<p>
				<label>vdef1：</label>
				<input name="vdef1"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef2：</label>
				<input name="vdef2"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef3：</label>
				<input name="vdef3"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef4：</label>
				<input name="vdef4"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef5：</label>
				<input name="vdef5"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef6：</label>
				<input name="vdef6"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef7：</label>
				<input name="vdef7"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef8：</label>
				<input name="vdef8"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>vdef9：</label>
				<input name="vdef9"  type="text" value="${item.ts }" size="30" />
			</p>
			<p>
				<label>ts：</label>
