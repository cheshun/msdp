				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							...
							<li><a >我的页面</a>
								<ul>
									<li><a href="demo/pagination/layout1.html" target="navTab" rel="pagination1">用户管理</a></li>
									<li><a href="demo/database/db_widget1.html" target="navTab" rel="pagination1">主子表</a></li>
									<li><a href="cheng/ass_tree.html" target="navTab" rel="pagination1">模板分配</a></li>
									<li><a href="cheng/treeform.html" target="dialog" rel="page1">角色分配页面</a></li>
