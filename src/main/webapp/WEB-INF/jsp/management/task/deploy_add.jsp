...
<form method="post" action="<c:url value='/management/task/deploy/save?navTabId=task_deploy&callbackType=closeCurrent'/>" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
	...
	<div class="pageFormContent" layoutH="57">
		...
		<p>
			<label>插件信息：</label>
			<input type="hidden" id="pk.pk_taskplugin" name="pk_taskplugin" value="${pk_taskplugin}"/>
			<input type="text" id="pk.pluginname"  value=""  />
			<a class="btnLook" href="<c:url value='/management/uicomponent/ref/index?reftype=user&itemkey=pk_taskplugin'/>" rel="lookup_111" lookupGroup="pk">查找带回</a>		
		</p>
		<p>
			<label>任务描述: </label>
