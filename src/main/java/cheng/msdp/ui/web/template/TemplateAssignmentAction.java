package cheng.msdp.ui.web.template;

import cheng.msdp.ui.model.*;
...
public class TemplateAssignmentAction  extends BusinessCommonAction {
	...
	public String initAssignmentPage(HttpServletRequest request, TemplateParamVO paramvo ,Model model) throws BusinessException {
		...
		List<ButtonModel> listbutton =queryseervice.queryByClause(ButtonModel.class, " pk_node='"+paramvo.getPk_data()+"' and dr=0 ");
		//查询 pk_data 的非默认报表模板 
